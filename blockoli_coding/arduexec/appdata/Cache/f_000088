...
Blockly.Arduino.map = {};
Blockly.Arduino.base_map = function(a, b, c, d) {
  var e = Blockly.Arduino.valueToCode(a, "NUM", Blockly.Arduino.ORDER_NONE) || "0";
  d = Blockly.Arduino.valueToCode(a, "INPUTNUM1", Blockly.Arduino.ORDER_ATOMIC) || "0";
  c = Blockly.Arduino.valueToCode(a, "INPUTNUM2", Blockly.Arduino.ORDER_ATOMIC) || "0";
  b = Blockly.Arduino.valueToCode(a, "DMIN", Blockly.Arduino.ORDER_ATOMIC) || "0";
  a = Blockly.Arduino.valueToCode(a, "DMAX", Blockly.Arduino.ORDER_ATOMIC) || "0";
  return ["map(" + e + ", " + d + ", " + c + ", " + b + ", " + a + ")", Blockly.Arduino.ORDER_NONE]
};
