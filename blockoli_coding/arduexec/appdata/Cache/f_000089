...
Blockly.Blocks.io_digitalwrite = {
  init: function() {
    ...
    this.appendValueInput("STATE").appendField(Blockly.Msg.ARD_DIGITALWRITE).appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.digitalPins), "PIN").setCheck(Blockly.Types.BOOLEAN.checkList);
