...
Blockly.Msg.ARD_DIGITALREAD = "디지털 값을 읽을 핀 번호";
Blockly.Msg.ARD_DIGITALREAD_TIP = "디지털 값을 읽기: HIGH 또는 LOW";
Blockly.Msg.ARD_DIGITALWRITE = "디지털 값을 입력할 핀 번호";
Blockly.Msg.ARD_DIGITALWRITE_TIP = "특정 핀에 HIGH 또는 LOW를 입력";
Blockly.Msg.ARD_FUN_RUN_LOOP = "아두이노 반복 loop(): ";
Blockly.Msg.ARD_FUN_RUN_SETUP = "아두이노 처음 한 번 실행 setup():";
Blockly.Msg.ARD_FUN_RUN_TIP = "아두이노 setup()과 loop() 기능을 정의합니다.";
Blockly.Msg.ARD_HIGH = "HIGH";
Blockly.Msg.ARD_HIGHLOW_TIP = "핀의 상태를 High 또는 Low로 설정합니다.";
Blockly.Msg.ARD_LOW = "LOW";
Blockly.Msg.ARD_MAP = " 숫자 변환(Map)";
Blockly.Msg.ARD_MAP_TIP = "[0~1024] 범위에서 다른 범위로 새롭게 매핑합니다.";
Blockly.Msg.ARD_MAP_VAL = "값(value)을 [0-";
Blockly.Msg.ARD_NOTONE = "음소거할 핀 번호";
Blockly.Msg.ARD_NOTONE_PIN = "소리 끔 핀 번호";
Blockly.Msg.ARD_NOTONE_PIN_TIP = "소리 출력을 멈출 핀을 설정합니다.";
Blockly.Msg.ARD_NOTONE_TIP = "선택한 핀의 소리 출력을 멈춥니다.";
Blockly.Msg.ARD_PIN_WARN1 = "Pin %1 is needed for %2 as pin %3. Already used as %4.";  // untranslated
Blockly.Msg.ARD_PULSEON = "로 읽기(Read)  핀 번호";
Blockly.Msg.ARD_PULSEREAD = "펄스 값을";
Blockly.Msg.ARD_PULSETIMEOUT = "펄스 시작을 기다릴 시간 ";
Blockly.Msg.ARD_PULSETIMEOUT_MS = "";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "선택한 핀의 펄스가 끝날 때까지의 길이를 측정합니다.";
Blockly.Msg.ARD_PULSE_TIP = "선택한 핀의 펄스의 길이를 측정합니다.";
Blockly.Msg.ARD_SERIAL_BPS = "bps";
Blockly.Msg.ARD_SERIAL_PRINT = "화면 출력";
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "새로운 줄 추가";
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "사람이 읽을 수 있는 ASCII 문자로 콘솔/시리얼 포트로 데이터를 출력합니다.";
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "A setup block for %1 must be added to the workspace to use this block!";
Blockly.Msg.ARD_SERIAL_SETUP = "설정";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "시리얼 통신을 위한 속도를 선택하세요.";
Blockly.Msg.ARD_SERIAL_SPEED = ":  시리얼 통신속도";
Blockly.Msg.ARD_SERVO_READ = "서보모터 각도 값을 읽을 핀 번호";
Blockly.Msg.ARD_SERVO_READ_TIP = "서보모터의 현재 각도 값을 읽습니다.";
Blockly.Msg.ARD_SERVO_WRITE = "서보모터가 연결된 핀";
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "도(0~180)로 설정";
Blockly.Msg.ARD_SERVO_WRITE_TIP = "서보모터를 특정 각도로 설정합니다.";
Blockly.Msg.ARD_SERVO_WRITE_TO = "을";
Blockly.Msg.ARD_SETTONE = "음정 설정 핀 번호";
Blockly.Msg.ARD_SPI_SETUP = "설정";
Blockly.Msg.ARD_SPI_SETUP_CONF = "환경설정:";
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "클럭 나누기";
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSBFIRST";
Blockly.Msg.ARD_SPI_SETUP_MODE = "SPI 데이터 모드 설정 ";
...
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "데이터 이동";
Blockly.Msg.ARD_SPI_SETUP_TIP = "SPI 주변기기 통신을 설정합니다.";
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "특정 슬레이브 기기에게 SPI 메시지를 전송하고 데이터를 수신합니다.";
Blockly.Msg.ARD_SPI_TRANS_NONE = "없음";
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "슬레이브 핀";
Blockly.Msg.ARD_SPI_TRANS_TIP = "특정 슬레이브 기기에게 SPI 메시지를 전송합니다.";
Blockly.Msg.ARD_SPI_TRANS_VAL = "전송 데이터";
...
Blockly.Msg.ARD_STEPPER_MOTOR = "설정하기:";
Blockly.Msg.ARD_STEPPER_PIN1 = "1번핀";
Blockly.Msg.ARD_STEPPER_PIN2 = "2번핀";
Blockly.Msg.ARD_STEPPER_REVOLVS = "스텝 모터의 1바퀴 스텝 수 입력";
Blockly.Msg.ARD_STEPPER_SETUP = "스텝모터";
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "스텝모터 출력 핀과 다른 설정값을 설정합니다.";
Blockly.Msg.ARD_STEPPER_SPEED = "회전 속도(rpm)";
Blockly.Msg.ARD_STEPPER_STEP = "회전할 스텝모터";
Blockly.Msg.ARD_STEPPER_STEPS = "스텝";
Blockly.Msg.ARD_STEPPER_STEP_TIP = "스텝모터가 특정 횟수의 스텝만큼 회전합니다.";
Blockly.Msg.ARD_TIME_DELAY = "멈춤";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "microseconds(us)";
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "특정 microseconds 만큼 멈추게 합니다.";
Blockly.Msg.ARD_TIME_DELAY_TIP = "특정 milliseconds 만큼 멈추게 합니다.";
Blockly.Msg.ARD_TIME_INF = "무한루프(end program)";
Blockly.Msg.ARD_TIME_INF_TIP = "프로그램 진행을 멈추게 하거나, 조건 없는 대기를 하게 합니다.";
Blockly.Msg.ARD_TIME_MICROS = "현재 경과시간 (us)";
Blockly.Msg.ARD_TIME_MICROS_TIP = "아두이노 보드가 시작하고 나서 지금까지의 시간을 microseconds 단위로 정수 값을 반환합니다.";
Blockly.Msg.ARD_TIME_MILLIS = "현재 경과시간 (ms)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "아두이노 보드가 시작하고 나서 지금까지의 시간을 milliseconds 단위로 정수 값을 반환합니다.";
Blockly.Msg.ARD_TIME_MS = "milliseconds(ms)";
Blockly.Msg.ARD_TONEFREQ = "주파수";
Blockly.Msg.ARD_TONE_FREQ = "frequency";
Blockly.Msg.ARD_TONE_PIN = "주파수 출력 핀 번호";
Blockly.Msg.ARD_TONE_PIN_TIP = "해당 핀에서 소리를 출력합니다.";
Blockly.Msg.ARD_TONE_TIP = "해당 핀에 출력할 주파수를 31 ~ 65535 범위에서 설정합니다.";
Blockly.Msg.ARD_TONE_WARNING = "주파수 범위는 31 ~ 65535 에서만 설정해야 합니다.";
Blockly.Msg.ARD_TYPE_ARRAY = "배열";
Blockly.Msg.ARD_TYPE_BOOL = "불 대수";
Blockly.Msg.ARD_TYPE_CHAR = "문자";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "ChildBlockMissing";  // untranslated
Blockly.Msg.ARD_TYPE_DECIMAL = "10진수";
Blockly.Msg.ARD_TYPE_LONG = "넓은 범위의 숫자";
Blockly.Msg.ARD_TYPE_NULL = "빈 값";
Blockly.Msg.ARD_TYPE_NUMBER = "숫자형";
Blockly.Msg.ARD_TYPE_SHORT = "좁은 범위의 숫자";
Blockly.Msg.ARD_TYPE_TEXT = "텍스트형";
Blockly.Msg.ARD_TYPE_UNDEF = "정의되지 않음";
Blockly.Msg.ARD_VAR_AS = "다음 자료형으로 설정";
Blockly.Msg.ARD_VAR_AS_TIP = "값을 특정 자료형으로 변환합니다.";
Blockly.Msg.ARD_WRITE_TO = "을";
...
Blockly.Msg.COLLAPSE_ALL = "전체블록 접기";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "빨강,파랑,초록의 값을 이용하여 색을 만듭니다. 모든 값은 0과 100 사이에 있어야 합니다.";
...
Blockly.Msg.CONTROLS_FOR_TITLE = "인덱스 %1를 %2에서 %3까지 %4씩 바꾸며 동작";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "블록 안의 명령을 반복해서 실행합니다.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "반복문의 조건을 만족하는 동안만 반복합니다.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "반복문의 조건이 만족하지 않을 때까지 반복합니다.";
...
Blockly.Msg.EXPAND_ALL = "전체블록 펼치기";
...
Blockly.Msg.LISTS_SPLIT_WITH_DELIMITER = "구분문자를 이용해 분리";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "랜덤 실수";
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "0.0 (포함)과 1.0 (배타적) 사이의 임의 실수 값을 돌려줍니다.";
Blockly.Msg.MATH_RANDOM_INT_HELPURL = "https://en.wikipedia.org/wiki/Random_number_generation";
Blockly.Msg.MATH_RANDOM_INT_TITLE = "랜덤 정수(%1<= n <=%2)";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "어떤 각도(degree)의 cos(cosine) 값을 계산해 돌려줍니다.";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "어떤 각도(degree)의 sin(sine) 값을 계산해 돌려줍니다.";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "어떤 각도(degree)의 tan(tangent) 값을 계산해 돌려줍니다.";
Blockly.Msg.ME = "나";
Blockly.Msg.NEW_INSTANCE = "새 인스턴스";  // untranslated
Blockly.Msg.NEW_INSTANCE_TITLE = "새 인스턴스 이름 설정하기";  // untranslated
Blockly.Msg.NEW_VARIABLE = "새 변수";
Blockly.Msg.NEW_VARIABLE_TITLE = "새 변수 이름 설정하기";
...
Blockly.Msg.RENAME_INSTANCE = "인스턴스 이름 변경";  // untranslated
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "추가";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "문자열 처음부터 추출합니다.";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "문자열 마지막에서 # 번째부터 추출합니다.";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "문자열 처음부터 # 번째 문자부터 추출합니다.";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = "문자열 마지막 글자를 추출합니다.";
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP = "문장 중 일부를 얻어내 반환합니다.";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER = "수를 입력 받습니다.";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT = "문장을 입력 받습니다.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP = "문장의 왼쪽/오른쪽/양쪽에서 공백 문자를 제거해 돌려줍니다.";
